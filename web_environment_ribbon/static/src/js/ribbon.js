    ...
    core.bus.on("web_client_ready", null, function() {
        ...
        rpc.query({
            ...
            if (ribbon_data.name && ribbon_data.name !== "False") {
                ...
                ribbon.show();
                document.getElementsByClassName("o_main_navbar")[0].style.borderColor = "black";
                document.getElementsByClassName("o_main_navbar")[0].style.backgroundColor = 'rgb(0,0,0)';
                document.getElementsByClassName("o_main_navbar")[0].style.backgroundImage = "none";
            }
            // Ribbon color
